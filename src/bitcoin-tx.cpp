...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s karimuncoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  karimuncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded karimuncoin transaction") + "\n" +
              "  karimuncoin-tx [options] -create [commands]   " + _("Create hex-encoded karimuncoin transaction") + "\n" +
              "\n";
